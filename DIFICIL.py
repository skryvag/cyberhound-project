...
class Shooter(arcade.Window):
    ...
    def add_inimigo(self, delta_time : float):
        ...
        inimigo.velocity = (random.randint(-18, -6), 0)
    ...
    def add_star(self, delta_time : float):
        ...
        star.velocity = (random.randint(-15, -2), 0)
        #O atributo de velocidade de qualquer objeto tem um valor X e um Y
    ...
    def add_planeta(self, delta_time : float):
        ...
        planeta.velocity = (random.randint(-6, -1), 0)
        #O atributo de velocidade de qualquer objeto tem um valor X e um Y
    ...
    def on_draw(self):
        ...
        if self.gamestarted==True:
            ...
            self.player.draw()
            arcade.draw_text("Pontuação: " + str(self.pontos), 0, ScreenHeight, arcade.color.WHITE, 20, anchor_x = "left", anchor_y = "top", font_name = 'fontes/pontosfont2.ttf')
            arcade.draw_text("Maior Pontuação: " + str(self.highpontos), ScreenWidth, ScreenHeight, arcade.color.WHITE, 20, anchor_x = "right", anchor_y = "top", font_name = 'fonts/pontosfont2.ttf')
            if self.lives == 3:
                self.life3.draw()
            elif self.lives == 2:
                self.life2.draw()
